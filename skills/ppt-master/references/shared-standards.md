...
- Do not pass ad-hoc flags to the legacy post-processing commands. `svg_to_pptx.py --only native|legacy` is the only supported optional flag and may be used when the user specifically wants just one variant

...
| Draft preview | `build_preview_html.py`, `review_server.py` | this README |
...
- Prefer `review_server.py` over plain `http.server` whenever browser comments should update files directly
